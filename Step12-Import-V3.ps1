<#
.SYNOPSIS
  Phase 1 V3 (FULLY STANDALONE) - Build dest portgroups + import as Org VDC
...
Write-Host "=== Phase 1 V3 (standalone, optimized): build portgroup + import Org VDC Network ===" -ForegroundColor Cyan
...
try {
    ...
    $summary = [ordered]@{
        ...
        createdBy       = 'Step12-Import-V3.ps1 (standalone)'
        config          = $ConfigPath
