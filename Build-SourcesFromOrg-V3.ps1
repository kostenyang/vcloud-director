...
.DESCRIPTION
  ...
  Output: cfg.json shape compatible with Step12-Import-V3.ps1 and
  Step3-Switch-V3.ps1.
...
Write-Host "  pwsh ./Step12-Import-V3.ps1   # phase 1: build + import"
Write-Host "  pwsh ./Step3-Switch-V3.ps1    # phase 2: switch NICs"
