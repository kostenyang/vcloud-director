...
**完整 step-by-step 操作流程請看 [WORKFLOW.md](WORKFLOW.md)**(per-tenant + vDS 整批兩種情境、回滾)。本文檔是元件設計與參數說明。

**密碼處理 / 安全注意事項請看 [CREDENTIALS.md](CREDENTIALS.md)**(prompt vs 變數 vs git 防呆)。
